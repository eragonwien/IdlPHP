...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($_POST['id'])) {
        array_push($errors, "Team id is required");
    }
    ...
    if (!ctype_digit($_POST['id'])) {
        array_push($errors, "Team Id must be a number");
    }

    if (!empty($_POST['leader_id']) && !ctype_digit($_POST['leader_id'])) {
        array_push($errors, "Team Leader Id must be a number");
    }
